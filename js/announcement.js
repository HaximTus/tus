...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>PDF 试卷预览优化。</strong>已收录试卷现常驻阿里云服务器，预览资源预取已切换至国内文件源，并提前加载手机端渲染组件。手机端降低后台渲染的内存占用，返回详情时优先恢复界面、随后清理预览资源，以减少首次等待和交互阻塞。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_preview_warmup_cleanup';
