...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>试卷访问优化。</strong>已收录试卷现常驻阿里云服务器，在线预览、资源预取与文件下载均优先使用国内文件源，并支持断点传输与中文下载文件名。此次进一步修正了 PDF 分段传输协议，并为夸克浏览器增加兼容预览与同源下载路径，减少部分手机和电脑浏览器的预览、下载失败。手机端同时提前加载渲染组件、降低后台渲染的内存占用，返回详情时优先恢复界面、随后清理预览资源。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_quark_compat';
