...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>试卷访问优化。</strong>在线预览统一使用兼容范围更广的经典 PDF 渲染组件，避免模块脚本与浏览器内置查看器差异；文件下载统一通过附件接口保存，避免部分浏览器将 PDF 打开为新标签页。PDF 优先显示第一页，其余页面在滚动接近时按需加载。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_pdfjs3_attachment';
