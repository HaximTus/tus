...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>试卷访问优化。</strong>在线预览与文件下载现统一使用站点同源文件，避免跨域下载及不同浏览器原生 PDF 查看器造成的兼容问题；PDF 预览统一由本地渲染组件完成，优先显示第一页，其余页面在滚动接近时按需加载。阿里云继续保存完整试卷并作为预览备用来源。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_universal_pdf';
