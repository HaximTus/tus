...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>PDF 试卷预览优化。</strong>电脑端保持原有预览方式；手机端先显示稳定的原生预览，在站内渲染准备完成后自动切换为适配预览框宽度的多页视图，并修复移动端返回详情按钮失效问题。返回详情时会清理全部预览状态，再次进入仍使用相同的国内代理地址。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_pdf_mobile_back_fix';
