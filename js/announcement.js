...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>PDF 试卷预览优化。</strong>预览文件继续使用国内服务器代理与缓存，并恢复浏览器原生预览方式；返回详情时会完整清理当前预览，再次进入仍使用相同的国内代理地址，避免重复窗口与来源切换。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_pdf_native_stable';
