...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>PDF 试卷预览优化。</strong>预览文件现由国内服务器代理并缓存，支持按需分段加载；移动端改用站内 PDF 渲染方式，并增加模块预加载、缓存预热和首次失败自动重试，以减少等待时间并改善页面宽度适配与首次打开的稳定性。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_pdf_preview_warmup';
