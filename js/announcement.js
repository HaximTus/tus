...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>PDF 试卷预览优化。</strong>预览文件继续使用国内服务器代理与缓存，不调整文件来源；移动端预览内容现限制在预览框宽度内，并支持连续查看 PDF 的全部页面。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_pdf_mobile_pages';
