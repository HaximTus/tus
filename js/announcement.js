...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>PDF 试卷预览优化。</strong>预览文件继续使用国内服务器代理与缓存，不调整文件来源；移动端预览内容现限制在预览框宽度内，第一页优先显示，后续页面在向下翻阅时按需加载。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260714_pdf_streaming';
