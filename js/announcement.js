...
(function () {
  ...
  var BODY_HTML =
    ...
    '<p><strong>试卷访问优化。</strong>试卷预览与下载现已统一从 haximtus.cn 同源获取，不再依赖外部 CDN、GitHub Raw 或未备案 API；预览框同步适配桌面宽屏、手机全屏和安全区域。PDF 优先显示第一页，其余页面在滚动接近时按需加载。</p>' +
  ...
  /* ========== 存储键 ========== */
  var SEEN_KEY = 'tus_announcement_seen_20260715_same_origin_papers';
